...
public class AclRuleVO extends PageRequest {
    ...
    private DataManagerCode.AclRuleCondition condition;
    ...
    public DataManagerCode.AclRuleCondition getCondition() {
        return condition;
    }

    public void setCondition(DataManagerCode.AclRuleCondition condition) {
