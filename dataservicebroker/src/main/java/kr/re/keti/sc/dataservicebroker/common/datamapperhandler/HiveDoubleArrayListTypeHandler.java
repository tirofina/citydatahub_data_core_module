 ...
 */
public class HiveDoubleArrayListTypeHandler
  extends BaseTypeHandler<ArrayList<Double>> {
  ...
  @Override
  public ArrayList<Double> getNullableResult(ResultSet rs, String columnName)
    throws SQLException {
  ...
  @Override
  public ArrayList<Double> getNullableResult(ResultSet rs, int columnIndex)
    throws SQLException {
    return null;
  }

  @Override
  public ArrayList<Double> getNullableResult(
