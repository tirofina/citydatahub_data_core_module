  ...
  <div class="content">
        ...
        <div class="col-12">
          <div class="card">
            <div class="card-header">
              <h4 class="card-title">Map Search (latest)</h4>
              <!-- v2.0 dashboard add -->
              <div class="mt-12 mb-12 text-right">
                ...
                <el-button type="primary" icon="el-icon-edit" size="small" :disabled="!latestValue" @click="createMap">New map</el-button>
                <el-button type="info" icon="el-icon-check" size="small" @click="saveMap">Save</el-button>
                <el-button type="info" icon="el-icon-delete" size="small" :disabled="isRemoveBtn" @click="removeMap">Delete</el-button>
              </div>
              <!-- v2.0 dashboard add -->
            </div>
              ...
              <div class="mt-4 mb-2">
                <div class="row">
                  ...
                  <div class="col text-right">
                    ...
                    <el-button size="small" type="info" style="margin-right: 1px;" @click="getEntitiesIsMap">Search</el-button>
                  </div>
                </div>
              </div>
              ...
              <div class="row">
                ...
                <div class="col-xl-4">
                  <div class="text-right mt-2 mb-2">
                    <el-button size="small" type="info" @click="goSubscriptions(true)">Subscribe</el-button>
                    <el-button size="small" type="info" :disabled="isHistoryBtn" @click="goHistoryView">Fetch Historical Data</el-button>
                  </div>
                  <strong style="font-size: 12px;">* Check for Subscription.</strong>
                  <grid
                    :data="gridData"
    ...
    >
      ...
      <template v-slot:inputBox>
        <label class="mr-sm-2 ml-4">Keywords</label>
        <b-form-input
  ...
  export default {
    ...
    data () {
      return {
        ...
        latestList: [],
        latestValue: null,
        latestName: 'Please enter a title.',
        searchCondition: [],
    ...
    methods: {
      focusOut() {
        ...
        if (!this.latestName) {
          this.latestName = 'Please enter a title.';
        }
      },
      changeName() {
