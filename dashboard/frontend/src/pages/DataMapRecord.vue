        ...
        <div class="col-12">
          <div class="card">
            <div class="card-header">
              <h4 class="card-title">Map Search (historical)</h4>
              <div class="mt-4">
                <b-form inline>
                  ...
                  <label class="mr-sm-2">Entity ID</label>
                  ...
                  <label class="mr-sm-2 ml-2">Keywords</label>
                  <b-form-input
                  ...
                  <el-button size="small" type="primary" @click="getMapRecord" v-if="!isBtnLoading">Search</el-button>
  ...
  export default {
    ...
    data () {
      return {
        ...
        dataModels: [],
        selected2: null,
        entityList: [{ value: null, text: 'Please select an option', disabled: true }],
        isBtnLoading: false,
        searchData: null,
        detailData: {},
        detailId: null,
    ...
    methods: {
      ...
      getMapRecord() {
        ...
        if (!this.selected2) {
          this.$alert('Select Data Entity ID(s).', '', {
            confirmButtonText: 'OK'
          });
          return null;
        }
