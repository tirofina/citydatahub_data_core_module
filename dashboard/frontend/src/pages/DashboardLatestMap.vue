  ...
  <div style="padding: 20px;">
    ...
    <div class="col-xl-4" style="display: none;">
      <div class="text-right mt-2 mb-2">
        <el-button size="small" type="primary" @click="goSubscriptions(true)">Subscribe</el-button>
        <el-button size="small" type="primary" :disabled="isHistoryBtn" @click="goHistoryView">Fetch Historical Data</el-button>
      </div>
